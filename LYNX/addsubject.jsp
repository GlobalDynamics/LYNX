  ...
  <li><a href="#">Enrollment</a>
        ...
        <section id="playground">
            ...
            <div class="three-fourths breadcrumb">
                ...
                <span class="middle"></span>
                <span><a href="#">Add a Subject</a></span>
                <span class="end"></span>
            </div>
            ...
            <div class="clear"></div>
             ...
             <form name = "ap" id = "ap" method = "post" action = "CourseController.jsp">
						<input type="hidden" name="type" id = "type" value="aSubject">
            <div class="one-half">
            	<div class="box">
                	<div class="inner">
                    	<div class="titlebar"><span>Add a Subject</span></div>
                        <div class="contents">
            			
            
            					<div class="row">
            					<p>Enter the name of the subject</p>
                            	<label>Name:</label> <div class="field-box"><input id = "sname" name = "sname" type="text" maxlength = "50" class="large"></div>
                                <div class="clear"></div>
                            	</div>
                                    
                                    <div class="row">
                                    <p>Select the calendar that the subject is part of</p>
