...
public class AddressController extends lynx.Manager{
	...
	public static int createAddress(String street, String zip, String city, String country,String  direction, String state, String apt,String  house,String  phone, String email) throws SQLException
	
	{
		con = cpds.getConnection();
		con.setAutoCommit(false);
		SQL = "INSERT INTO [address] (street, zipcode, city, country, direction, state, apt, house_no, phone, email) " + "VALUES (?,?,?,?,?,?,?,?,?,?)";
	...
	public static void editAddress(int addressID, String street, String zip, String city, String country,String  direction, String state, String apt,String  house,String  phone, String email) throws SQLException
	{
		con = cpds.getConnection();
		con.setAutoCommit(false);
		...
		try {
			...
			if (!rs.isBeforeFirst()) {
				...
				while (rs.next()) {
					...
					ad = new Address(rs.getString("street"), rs.getString("zipcode"), rs.getString("apt"), rs.getString("house_no"), rs.getString("direction"), rs.getString("state"), rs.getString("city"), rs.getString("phone"), rs.getString("country"), rs.getString("email"));
					i++;
				}
				return ad;
