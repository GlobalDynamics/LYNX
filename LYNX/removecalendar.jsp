    ...
    <div id="container">
        ...
        <section id="playground">
            ...
            <div class="three-fourths breadcrumb">
                ...
                <span class="middle"></span>
                <span><a href="#">Add a Student</a></span>
                <span class="end"></span>
            </div>
            ...
            <div class="clear"></div>
             ...
             <form name = "ap" id = "ap" method = "post" action = "CalendarController.jsp">
						<input type="hidden" name="type" id = "type" value="rCalendar">
            <div class="one-half">
            	<div class="box">
                	<div class="inner">
                    	<div class="titlebar"><span>Remove a Calendar</span></div>
                        <div class="contents">
            			
            <div class="row">
            
            <p>Removing a calendar will remove all subject associated with this calendar, which will in turn remove all courses associates with all subject in this calendar.</p>
                            	<label>Select a calendar to remove</label> <div class="field-box">
