  ...
  <li><a href="#">Enrollment</a>
        ...
        <section id="playground">
            ...
            <div class="three-fourths breadcrumb">
                ...
                <span class="middle"></span>
                <span><a href="#">Remove a Teacher</a></span>
                <span class="end"></span>
            </div>
            ...
            <div class="clear"></div>
             ...
             <form name = "ap" id = "ap" method = "post" action = "TeacherController.jsp">
						<input type="hidden" name="type" id = "type" value="rTeacher">
            <div class="one-half">
            	<div class="box">
                	<div class="inner">
                    	<div class="titlebar"><span>Remove a teacher</span></div>
                        <div class="contents">
            			
            <div class="row">
            
            <p>Select a teacher to remove</p>
                            	<label>Select a teacher to remove</label> <div class="field-box">
                                	<select id = "teachers" name = "teachers" data-placeholder="No Data" style="width:350px;" class="chzn-select" tabindex="6">
                                      ...
                                      Teacher[] test = PersonController.getTeachers();
                                       ...
                                       {
                                    	   out.println("<p>There are no people to remove.");
                                       }
