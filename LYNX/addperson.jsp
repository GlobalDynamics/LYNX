...
<!-- Validation engine -->
<script type="text/javascript"
	src="js/languages/jquery.validationEngine-en.js" charset="utf-8"></script>
						...
						<form name="ap" id="ap" method="post"
							...
							<div class="titlebar">
								<span class="icon entypo white browser"></span> <span
									class="w-icon">Standard Fields</span>
							</div>
							<div class="contents">
								...
								<div class="row">
									<label>Suffix</label>
									<div class="field-box">
										<input id="suffix" name="suffix" type="text" maxlength="4"
											class="tiny">
									</div>
									<div class="clear"></div>
								</div>
								...
								<div class="row">
									<label>Gender</label>
									<div class="field-box">
										<input id="gender" name="gender" type="text" maxlength="2"
											class="tiny">
									</div>
									<div class="clear"></div>
								</div>
								...
								<div class="row">
									...
									<div class="field-box">
										<span class="icon entypo calendar for-input"></span> <input
											name="birth" id="birth" type="text"
											class="w-icon medium validate[required, custom[date],past[2013/03/27]]">
									</div>
									<div class="clear"></div>
								</div>
