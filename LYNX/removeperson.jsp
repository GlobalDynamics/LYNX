  ...
  <li><a href="#">Enrollment</a>
        ...
        <section id="playground">
            ...
            <div class="three-fourths breadcrumb">
                ...
                <span class="middle"></span>
                <span><a href="#">Remove a Person</a></span>
                <span class="end"></span>
            </div>
            ...
            <div class="clear"></div>
             ...
             <form name = "ap" id = "ap" method = "post" action = "PersonController.jsp">
						<input type="hidden" name="type" id = "type" value="rPerson">
            <div class="one-half">
            	<div class="box">
                	<div class="inner">
            ...
            <div class="row">
            <p>Select a person to remove. Any associations to this person will be removed.</p>
                            	<label>Select a person to remove</label> <div class="field-box">
