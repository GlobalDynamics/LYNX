  ...
  <li><a href="#">Enrollment</a>
        ...
        <section id="playground">
            ...
            <div class="three-fourths breadcrumb">
                ...
                <span class="middle"></span>
                <span><a href="#">Edit a Teacher</a></span>
                <span class="end"></span>
            </div>
               
            <div class="clear"></div>
            
             <form name = "ap" id = "ap" method = "post" action = "TeacherController.jsp">
						<input type="hidden" name="type" id = "type" value="eTeacher">
            <div class="one-half">
            	<div class="box">
                	<div class="inner">
                    	<div class="titlebar"><span>Edit a Teacher</span></div>
                        <div class="contents">
            			
            
            					<div class="row">
            					<p>Select a teacher to Edit</p>
                            	<label>Select a teacher to Edit</label> <div class="field-box">
                                	<select id = "teachers" name = "teachers" data-placeholder="No Data" style="width:350px;" class="chzn-select" tabindex="6">
                                       <%
                                       
                                      Teacher[] test = PersonController.getTeachers();
                                       if(test != null)
                                       {
                                    	   for(Teacher value : test)
                                           {
                                    ...
                                    <div class="row">
                                    <p>Select the new person the teacher will be linked to</p>
                                    <label>Select a person to assign</label> <div class="field-box">
                                	<select id = "people" name = "people" data-placeholder="No Data" style="width:350px;" class="chzn-select" tabindex="6">
                                       <%
                                       
                                      Person[] test1 = PersonController.getPeopleWithoutStudent();
                                       if(test1 != null)
                                       {
                                    	   for(Person value : test1)
                                           {
