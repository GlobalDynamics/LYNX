  ...
  <li><a href="#">Enrollment</a>
        ...
        <section id="playground">
            ...
            <div class="three-fourths breadcrumb">
                ...
                <span class="middle"></span>
                <span><a href="#">Edit a Student</a></span>
                <span class="end"></span>
            </div>
               
            <div class="clear"></div>
            
             <form name = "ap" id = "ap" method = "post" action = "StudentController.jsp">
						<input type="hidden" name="type" id = "type" value="eStudent">
            <div class="one-half">
            	<div class="box">
                	<div class="inner">
                    	<div class="titlebar"><span>Edit Student</span></div>
                        <div class="contents">
            			
            
            					<div class="row">
            					<p>Select a student to Edit</p>
                            	<label>Select a student to Edit</label> <div class="field-box">
                                    ...
                                    <div class="row">
                                    <p>Select the new person the student will be linked to</p>
