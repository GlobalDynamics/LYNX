	...
	if (session.getAttribute("login") == null) {
		...
		if (login.equals("1")) {
			...
			if(request.getParameter("type") != null)
			{
				...
				{
					courseID = Integer.parseInt(request.getParameter("courses"));
  ...
  <li><a href="#">Enrollment</a>
        ...
        <section id="playground">
            ...
            <div class="three-fourths breadcrumb">
                ...
                <span class="middle"></span>
                <span><a href="#">Add a Course</a></span>
                <span class="end"></span>
            </div>
            ...
            <div class="clear"></div>
             ...
             <%
                                       ...
                                       String name = CourseController.getCourse(courseID);
                                    	   
                                    	   %>
						<input type="hidden" name="type" id = "type" value="aGrade">
						<input type="hidden" name="enroll" id = "type" value="<%=courseID%>">
            <div class="one-half">
            	<div class="box">
                	<div class="inner">
                        ...
                        <div class="contents">
            					...
            					<div class="row">
            					<p>Enter the letter grade for the course:</p>
                            	<label>Grade:</label> <div class="field-box"><input id = "grade" name = "grade" type="text" class="large" maxlength ="1"></div>
                                <div class="clear"></div>
                            	</div>
