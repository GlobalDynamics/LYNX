        ...
        <section id="playground">
            ...
            <p>Removing a Subject will remove all courses linked to this Subject.</p>
                            	<label>Select a subject to remove</label> <div class="field-box">
                                	<select id = "subjects" name = "subjects" data-placeholder="No Data" style="width:350px;" class="chzn-select" tabindex="6">
                                       <%
                                      ...
                                      Subject[] test = CourseController.getSubjects();
                                       if(test != null)
                                       {
                                           ...
                                           {
                                        	   out.println("<option id = \"" + value.getSubject() + "\"  value = \"" + value.getSubject() + "\">" + value.getName() + "</option>");
                                           }
                                       }
                                       else
                                       {
