				...
				<div class="profile">
					<div class="links">
						 <a href="logout.jsp"
							...
							<br>
								<form name = "ap" id = "ap" method = "post" action = "editsubject.jsp">
								<div class="field-box">
		...
		<section id="playground">
			...
			<div class="three-fourths breadcrumb">
				<span><a href="#" class="icon entypo home"></a></span> <span
					class="middle"></span> <span><a href="#">Courses</a></span> <span
					class="middle"></span> <span><a href="#">Edit a Subject</a></span>
				<span class="end"></span>
			</div>
			...
			<form name="ap" id="ap" method="post" action="CourseController.jsp">
				<input type="hidden" name="type" id="type" value="eSubject">
						...
						<div class="inner">
							...
							<div class="contents">
								...
								<div class="row">
									...
									<p>Select a subject to edit</p>
									<label>Select a subject to edit</label>
									<div class="field-box">
