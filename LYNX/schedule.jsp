			...
			<section id="playground">
				...
				<div class="three-fourths breadcrumb">
					<span><a href="#" class="icon entypo home"></a></span> <span
						class="middle"></span> <span><a href="#">Enrollment</a></span> <span class="middle"></span> <span><a href="#">Schedule</a></span>
					<span class="end"></span>
				</div>
				<!-- /Breadcrumb -->
				...
				<form name = "ap" id = "ap" method = "post" action = "schedule.jsp">
            	<div class="box">
                	<div class="inner">
                		...
                		<div class="row">
            					...
            					<p>Select a student to their schedule.</p>
                    	...
                    	<%
                            ...
                            if(request.getParameter("students") != null && request.getParameter("calendars") != null)
                            {
                            	%>
	                        ...
	                        <table>
	                            ...
	                            <tbody>
                            	 <%
                                      ...
                                      Schedule[] test3 = EnrollmentController.getSchedule(studentID,calendarID);
                                       if(test3 != null)
                                       {
                                    	   for(Schedule value : test3)
                                           {
                                        	   out.println("<tr>");
