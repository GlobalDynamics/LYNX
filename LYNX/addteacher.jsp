        ...
        <section id="playground">
            ...
            <div class="clear"></div>
             ...
             <form name = "ap" id = "ap" method = "post" action = "TeacherController.jsp">
						<input type="hidden" name="type" id = "type" value="aTeacher">
            <div class="one-half">
            	<div class="box">
                	<div class="inner">
                    	<div class="titlebar"><span>Add a teacher</span></div>
                        <div class="contents">
            			
            <div class="row">
            
            <p>Select a person to make into a teacher</p>
                            	<label>Select a person to add</label> <div class="field-box">
                                	<select id = "teachers" name = "teachers" data-placeholder="No Data" style="width:350px;" class="chzn-select" tabindex="6">
                                       <%
                                       
                                      Person[] test = PersonController.getPeopleWithoutStudent();
                                       if(test != null)
                                       {
